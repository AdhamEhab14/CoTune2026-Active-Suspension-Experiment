 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Jan 09 01:02:32 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                DualVL53L0X
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Dist1 of S-Function DualVL53L0X");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Dist2 of S-Function DualVL53L0X");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port MPU1 of S-Function DualVL53L0X");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port MPU2 of S-Function DualVL53L0X");
      return;
    }
...
{
  int32_T *Dist1 = (int32_T *) ssGetOutputPortRealSignal(S, 0);
  int32_T *Dist2 = (int32_T *) ssGetOutputPortRealSignal(S, 1);
  int16_T *MPU1 = (int16_T *) ssGetOutputPortRealSignal(S, 2);
  int16_T *MPU2 = (int16_T *) ssGetOutputPortRealSignal(S, 3);
  DualVL53L0X_Outputs_wrapper(Dist1, Dist2, MPU1, MPU2);
}
