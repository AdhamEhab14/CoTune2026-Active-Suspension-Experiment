 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri May 22 23:23:99 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Sensors
...
/* Output Port  3 */
#define OUT_PORT_3_NAME                vus_mps
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u_N of S-Function Sensors");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port d1_m of S-Function Sensors");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port d2_m of S-Function Sensors");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port vs_mps of S-Function Sensors");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port vus_mps of S-Function Sensors");
      return;
    }
...
{
  const real32_T *u_N = (real32_T *) ssGetInputPortRealSignal(S, 0);
  real32_T *d1_m = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real32_T *d2_m = (real32_T *) ssGetOutputPortRealSignal(S, 1);
  real32_T *vs_mps = (real32_T *) ssGetOutputPortRealSignal(S, 2);
  real32_T *vus_mps = (real32_T *) ssGetOutputPortRealSignal(S, 3);
  Sensors_Outputs_wrapper(u_N, d1_m, d2_m, vs_mps, vus_mps);
}
