 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue May 26 01:11:83 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Cloud_MQTT
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                K_out
#define OUTPUT_0_DIMS_ND               {1,4}
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                amp_out
...
/* Output Port  2 */
#define OUT_PORT_2_NAME                freq_out
...
/* Output Port  3 */
#define OUT_PORT_3_NAME                enable_lqr
...
/* Output Port  4 */
#define OUT_PORT_4_NAME                exp_running
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port d1_in of S-Function Cloud_MQTT");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port d2_in of S-Function Cloud_MQTT");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port vs_in of S-Function Cloud_MQTT");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port vus_in of S-Function Cloud_MQTT");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u_in of S-Function Cloud_MQTT");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port K_out of S-Function Cloud_MQTT");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port amp_out of S-Function Cloud_MQTT");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port freq_out of S-Function Cloud_MQTT");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port enable_lqr of S-Function Cloud_MQTT");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port exp_running of S-Function Cloud_MQTT");
      return;
    }
...
{
  const real32_T *d1_in = (real32_T *) ssGetInputPortRealSignal(S, 0);
  const real32_T *d2_in = (real32_T *) ssGetInputPortRealSignal(S, 1);
  const real32_T *vs_in = (real32_T *) ssGetInputPortRealSignal(S, 2);
  const real32_T *vus_in = (real32_T *) ssGetInputPortRealSignal(S, 3);
  const real32_T *u_in = (real32_T *) ssGetInputPortRealSignal(S, 4);
  real32_T *K_out = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real32_T *amp_out = (real32_T *) ssGetOutputPortRealSignal(S, 1);
  real32_T *freq_out = (real32_T *) ssGetOutputPortRealSignal(S, 2);
  boolean_T *enable_lqr = (boolean_T *) ssGetOutputPortRealSignal(S, 3);
  boolean_T *exp_running = (boolean_T *) ssGetOutputPortRealSignal(S, 4);
  Cloud_MQTT_Outputs_wrapper(d1_in, d2_in, vs_in, vus_in, u_in, K_out, amp_out,
    freq_out, enable_lqr, exp_running);
}
