 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Apr 17 17:30:50 2026
 */
...
/* Output Port  2 */
#define OUT_PORT_2_NAME                Acc_Middle_mps2
...
/* Output Port  3 */
#define OUT_PORT_3_NAME                Acc_Top_mps2
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port ToF1_m of S-Function Sensors");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port ToF2_m of S-Function Sensors");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Acc_Middle_mps2 of S-Function Sensors");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Acc_Top_mps2 of S-Function Sensors");
      return;
    }
...
{
  real32_T *ToF1_m = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real32_T *ToF2_m = (real32_T *) ssGetOutputPortRealSignal(S, 1);
  real32_T *Acc_Middle_mps2 = (real32_T *) ssGetOutputPortRealSignal(S, 2);
  real32_T *Acc_Top_mps2 = (real32_T *) ssGetOutputPortRealSignal(S, 3);
  Sensors_Outputs_wrapper(ToF1_m, ToF2_m, Acc_Middle_mps2, Acc_Top_mps2);
}
