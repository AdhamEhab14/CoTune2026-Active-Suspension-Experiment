 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Apr 12 15:26:75 2026
 */
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Pos1 of S-Function Sensors");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Vel1 of S-Function Sensors");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Pos2 of S-Function Sensors");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Vel2 of S-Function Sensors");
      return;
    }
...
{
  real32_T *Pos1 = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real32_T *Vel1 = (real32_T *) ssGetOutputPortRealSignal(S, 1);
  real32_T *Pos2 = (real32_T *) ssGetOutputPortRealSignal(S, 2);
  real32_T *Vel2 = (real32_T *) ssGetOutputPortRealSignal(S, 3);
  Sensors_Outputs_wrapper(Pos1, Vel1, Pos2, Vel2);
}
