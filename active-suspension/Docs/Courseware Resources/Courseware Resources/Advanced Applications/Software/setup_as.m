...
ks = 235;% or 1040 Suspension Stiffness (N/m) 
kt = 235;% or 2300
kus = kt;% Tire stiffness (N/m)
ms = 1.5;% or 2.5 Sprung Mass (kg) 
mu = 0.565;% or 1.150
mus = mu;% Unsprung Mass (kg)
bs = 5.76;% Suspension Inherent Damping coefficient (sec/m)
bus = 5.76;% Tire Inhenrent Damping coefficient (sec/m)
