...
export const URDFViewer = ({
    ...
    loader.load(
      ...
      (robot) => {
        ...
        setTimeout(() => {
          ...
          camera.position.set(0.12134207858963257,-1.142596136252635,0.8228021189082);
          camera.rotation.set(0.9777090432446208,0.007890223549720729,-0.011705277475360262);
  ...
  const moveCameraToPosition1 = () => {
    ...
    if (camera) {
      ...
      camera.rotation.set(
       1.3637024044444996,
        -0.00040476479857562696,
        0.001926474586604767
      );
    }
  ...
  const moveCameraToPosition2 = () => {
    ...
    if (camera) {
      ...
      camera.rotation.set(
        -0.007540842663790807,
        -0.005990310908224293,
        -0.000045172578117606264
      );
    }
    if (controlsRef.current) {
      controlsRef.current.enabled = false;
  ...
  const moveCameraToPosition3 = () => {
    ...
    if (camera) {
      ...
      camera.rotation.set(
        1.5707953267587027,
        4.063398156145537e-9,
        -0.004063228730181485
      );
    }
    if (controlsRef.current) {
      controlsRef.current.enabled = false;
