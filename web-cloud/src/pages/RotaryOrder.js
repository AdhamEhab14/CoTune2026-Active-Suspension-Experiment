...
const QUEUE_TABLE = "RotaryQueueTable";
...
const RotaryOrder = () => {
  ...
  return (
    <div className="pag">
      <Helmet><title>Rotary Control</title></Helmet>
      <h1>Rotary Pendulum Control Page</h1>
      <div className="vid-container">
        ...
        <div className="button-group">
          ...
          <button className="control-button" onClick={() => publishControl("$aws/things/RaspberryPiStreamer/shadow/name/Stream3Shadow/update", { state: { desired: { stream3: "on" } } })}>Start Stream</button>
          <button className="control-button" onClick={() => publishControl("$aws/things/RaspberryPiStreamer/shadow/name/Stream3Shadow/update", { state: { desired: { stream3: "off" } } })}>Stop Stream</button>
        </div>
      </div>
